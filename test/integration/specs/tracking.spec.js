...
describe('when using the tracking resource', () => {
    ...
    it('I can a list of api logs', async () => {
    ...
    // it('I can get a list of subscription logs', async () => {
    ...
    //
    //
    // it('I can get a subscription log by its ID', async() => {
    ...
    //
    //
    // it('I can get a list of webhook notification logs', async () => {
    ...
    // });
    //
    // it('I can get a webhook notification log by its ID', async() => {
    ...
    // });
    //
    // it('I can get a list of changes history', async () => {
